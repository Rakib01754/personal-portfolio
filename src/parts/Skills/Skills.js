        ...
        <section className="bg-gray-200">
            <div className="container px-5 py-10 mx-auto">
                ...
                <div className="flex flex-wrap -m-2">
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Javascript</h2>
                            </div>
                        </div>
                    </div>
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">React.js</h2>
                            </div>
                        </div>
                    </div>
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Node.js</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Express.js</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">MongoDB</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Firebase</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Tailwind Css</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Bootstrap</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3  w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">HTML5</h2>
                    ...
                    <div className="p-2 lg:w-1/4 md:w-1/3 w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">CSS3</h2>
                            </div>
                        </div>
                    </div>
                    <div className="p-2 lg:w-1/4 md:w-1/3 w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Github</h2>
                            </div>
                        </div>
                    </div>
                    <div className="p-2 lg:w-1/4 md:w-1/3 w-1/2">
                        <div className="h-full flex items-center border-white border p-4 rounded-lg shadow-lg">
                            ...
                            <div className="flex-grow">
                                <h2 className="text-gray-900 title-font font-bold text-xl">Netlify</h2>
                            </div>
                        </div>
                    </div>
                </div>
