...
const Contact = () => {
    ...
    return (
        <section class="text-black bg-gray-200 relative" id='contact'>
                    ...
                    <form ref={form} onSubmit={sendEmail} class="flex flex-wrap -m-2">
                        <div class="p-2 w-1/2">
                            <div class="relative">
                                ...
                                <input type="text" id="name" name="user_name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out" />
                            </div>
                        </div>
                        <div class="p-2 w-1/2">
                            <div class="relative">
                        ...
                        <div class="p-2 w-full flex justify-center">
                            <button type='submit' class="flex text-white bg-black hover:bg-orange-600 border-0 py-2 px-6 focus:outline-none rounded text-lg font-bold">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
