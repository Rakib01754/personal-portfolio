        ...
        <div className='container mx-auto' id='about'>
            <section className="text-black body-font py-10 text-justify">
                <div className="flex flex-col text-center w-full">
                    <h1 className="sm:text-5xl text-3xl font-medium title-font mb-12 text-[#F25B9D] underline">About Me</h1>
                </div>
                    ...
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center  font-mono">
                        ...
                        <div className="flex justify-center items-center">
                            <a href={resume} download>
                                <button className="flex text-white bg-black hover:bg-[#F25B9D] border-0 py-2 px-6 focus:outline-none rounded text-lg font-bold">Download Resume</button></a>
                        </div>
                    </div>
